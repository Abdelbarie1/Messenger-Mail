	...
	<div class="col-md-12">
					...
					<div class="col-md-3">
						...
						<div>
							<ul class="nav nav-pills nav-stacked">
								...
								<li class="active"><a href="Mailbox"><i class="fa fa-inbox"></i> <%="Inbox ("+emailMessages.length+")"%></a></li>
								<li><a href="#"><i class="fa fa-star"></i> Starred</a></li>
								<li><a href="#"><i class="fa fa-bookmark"></i> Important</a></li>
								<li><a href="#"><i class="fa fa-mail-forward"></i> Sent</a></li>
								<li><a href="#"><i class="fa fa-pencil-square-o"></i> Drafts</a></li>
								<li><a href="Deconnection"><i class="fa fa-remove"></i> Sing Out</a></li>
							</ul>
						</div>
					</div>
					<!-- END INBOX MENU -->
							...
							<div class="col-sm-6">
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li><a href="DeleteMAil">Delete</a></li>
									</ul>
								</div>
							</div>
		...
		for (int i = 0; i < emailMessages.length; i++) {
			   ...
			   %>
								<tbody><tr>
									<td class="action">
											<form action="DeleteMail?id=<%=message.getMessageNumber() %>&email=<%=request.getAttribute("email")%>&pwd=<%=request.getAttribute("pwd") %>" method="post">
											      <button type="submit" name="search"  class="btn_ btn-primary btn-sm search delete"><i class="fa fa-remove"></i></button>	
											</form>
									<td class="action"><i class="fa fa-star-o"></i></td>
									<td class="action"><i class="fa fa-bookmark-o"></i></td>
									<td class="name"><a href="#"><%=message.getFrom()[0] %></a></td>
									<td class="subject"><a data-toggle="modal"  href="showMsg?id=<%= message.getMessageNumber()-1 %>&email=<%=request.getAttribute("email")%>&pwd=<%=request.getAttribute("pwd") %>"><%= message.getSubject()%></a></td>
									<td class="time" id="date"><%= message.getSentDate()%></td>				
								</tr>
		<%}}
							%>
							</tbody></table>
